...
This project demonstrates a **Sales Insight Dashboard** created using **Microsoft Power BI**  for data analysis and cleaning. It analyzes multi-dimensional sales data to uncover patterns, trends, and high-value segments. The dashboard serves as a strategic tool for sales and business managers to make data-informed decisions.
...
## ✅ Conclusion
 ...
 The dashboard helps business teams make strategic decisions based on sales performance, customer segmentation, and regional opportunities.
## 🛠️ Tools & Skills Used
